...
| 函数工具 | 让 LLM 通过自然语言管理人格 | 支持导出文件、预设对话、函数工具/MCP 工具、Skills、自定义错误回复等完整字段 |
...
| `pp export 测试人格/女仆` | 将 `测试人格/女仆` 导出为文本文件 |
...
- `list` 输出的人格序号可用于 `view`、`export`、`update`、`avatar`、`delete` 和快捷切换。
